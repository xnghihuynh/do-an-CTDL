...
//ham khoi tao thoi gian
		ThoiGian(){}
		ThoiGian(int ngay, int thang, int nam, int gio, int phut){
			ThoiGian::ngay = ngay;
...
class Ve{
	private:
		string maVe;
		ThoiGian thoiGian;
		bool trangThai; //0 la het ve, 1 la con ve
	public:
//ham khoi tao ve
		Ve(){}
		Ve(string maVe, ThoiGian thoiGian, int cmnd){
			Ve::maVe = maVe;
